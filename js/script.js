        ...
        if (socket.readyState != 1) {
            ...
            fetch(UrlApi).then((response) => response.json().then((dataApi) => {
                ...
                if (valTemp < 0) {
                    ...
                    text2.textContent = "Banquise en vue !";
                ...
                if (valTemp2 < 0) {
                    ...
                    text3.textContent = "Canalisations gelées, appelez SOS plombier et mettez un bonnet !s";
                ...
                if (valTemp2 < 12) {
                    ...
                    text4.textContent = "Montez le chauffage ou mettez un gros pull !";
                ...
                if (valTemp2 > 22 && valTemp2 < 50) {
                    ...
                    text5.textContent = "Baissez le chauffage !";
                ...
                notif5.addEventListener("click", () => {
                    ...
                    notif5.classList.add("element-liste5");
                });

                if (valTemp2 > 50) {
                    console.log("Appelez les ompiers ou arrêtez votre barbecue !");

                    text6.textContent = "Appelez les ompiers ou arrêtez votre barbecue !";
                ...
                notif6.addEventListener("click", () => {
                    notif6.classList.remove("element-liste6-active");
                    notif6.classList.add("element-liste6");
                });

                valeurFinale = comptN1 + comptN2 + comptN3 + comptN4 + comptN5 + comptN6;
